...
export default function ConfigurationPage() {
  ...
  return (
    <DashboardPageLayout title="Configuration" description="Runtime client configuration." isAdmin={isAdmin} stickyHeader signedOut={{ message: "Sign in to view configuration.", forceRedirectUrl: "/configuration", signUpForceRedirectUrl: "/configuration" }}>
