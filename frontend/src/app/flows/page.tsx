...
export default function FlowsPage() {
  ...
  return (
    <DashboardPageLayout title="Flows" description="Critical flow health view." isAdmin={isAdmin} stickyHeader signedOut={{ message: "Sign in to view flows.", forceRedirectUrl: "/flows", signUpForceRedirectUrl: "/flows" }}>
